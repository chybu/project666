...
public final class LabRequestSpecification {

    private LabRequestSpecification(){
    }
    ...
    public static Specification<LabRequest> byCreatedAtRange(LocalDate minDate, LocalDate maxDate) {
        return (root, query, cb) -> {
